...
public class EmailService {
    ...
    public void sendTemplateEmail(TemplateEmailRequest request) throws Exception {
    ...
    public void sendPromotionalEmail(PromotionalEmailRequest request) throws Exception {
        MimeMessage message = mailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
